...
<div className='flex gap-[15px]'>
    ...
    <p className='text-[15px] font-normal leading-[23px] text-gray-600 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, laudantium fugit animi minima earum voluptas molestiae quod aliquam nihil velit deleniti dicta id amet repellat. Hic ratione quasi laboriosam veritatis.</p>
